...
public:
    ...
    info_agent(vector<string> teammate)  //构造函数2，智能体分组信息
    {
        namelist = {"/jurong", "/raffles", "/changi", "/sentosa", "/nanyang"};
...
public:
    ...
    : nh_ptr(nh_ptr_)
    {
        ...
        string str = nh_ptr->getNamespace();  //获取智能体名称 str
        str.erase(0, 1);
        ...
        sync_            = new message_filters::Synchronizer<MySyncPolicy>(MySyncPolicy(10), *cloud_sub_, *nbr_sub_, *odom_filter_sub_);   //消息软同步
